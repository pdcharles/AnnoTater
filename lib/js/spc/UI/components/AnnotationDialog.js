export let AnnotationDialog = function() {
 ...
 let _AnnotationDialog = function(ui) {
  ...
  this.tolerance.ppm.id = 'spc_ele_annotationDialog_tolerance_ppm';
  ...
  this.ionTypes.classList.add('spc_cls_dialog_item');
  ...
  .forEach(([ion,desc]) => {
   ...
   this.ionTypes.ions[ion].id = 'spc_ele_annotationDialog_ionTypes_ion_'+ion;
   ...
   this.ionTypes.labels[ion].for = 'spc_ele_annotationDialog_ionTypes_ion_'+ion;
   ...
   this.ionTypes.cols[ion].id = 'spc_ele_annotationDialog_ionTypes_col_'+ion;
  ...
  this.smartFilter.classList.add('spc_cls_dialog_item');
  this.smartFilter.perform = document.createElement('input');
  this.smartFilter.id = 'spc_ele_annotationDialog_smartFilter_perform';
  ...
  this.smartFilter.perform_label.for = 'spc_ele_annotationDialog_smartFilter_perform';
  ...
  this.smartZoom.classList.add('spc_cls_dialog_item');
  this.smartZoom.perform = document.createElement('input');
  this.smartZoom.id = 'spc_ele_annotationDialog_zoom_perform';
  ...
  this.smartZoom.perform_label.for = 'spc_ele_annotationDialog_zoom_perform';
