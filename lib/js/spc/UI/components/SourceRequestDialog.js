export let SourceRequestDialog = function() {
 ...
 let _SourceRequestDialog = function(ui) {
  ...
  this.dataSource.button.id = 'spc_ele_sourceRequestDialog_dataSource_button';
  this.dataSource.button.classList.add('spc_cls_dialog_button');
 ...
 _SourceRequestDialog.prototype.update = function() {
  spc.UI.removeChildren(this.dataSource.fileNames);
