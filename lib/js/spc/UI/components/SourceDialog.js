export let SourceDialog = function() {
 ...
 let _SourceDialog= function(ui) {
  ...
  this.dataSource.classList.add('spc_cls_dialog_item');

  this.dataSource.chooser_label = document.createElement('label');
  this.dataSource.chooser_label.for = 'spc_ele_sourceDialog_dataSource_chooser';
  ...
  this.dataSource.chooser.id = 'spc_ele_sourceDialog_dataSource_chooser';
  ...
  this.mzFileDetails.classList.add('spc_cls_dialog_item','hide');
  this.mzFileDetails.scanNumber_label = document.createElement('label');
  this.mzFileDetails.scanNumber_label.for = 'spc_ele_sourceDialog_mzFileDetails_scanNumber';
  ...
  this.mzFileDetails.scanNumber.id = 'spc_ele_sourceDialog_mzFileDetails_scanNumber';
  ...
  this.node.append(spc.UI.components.common.separator());
  ...
  this.peptideDetails.classList.add('spc_cls_dialog_item');

  this.peptideDetails.sequence_label = document.createElement('label');
  this.peptideDetails.sequence_label.for = 'spc_ele_sourceDialog_peptideDetails_sequence';
  ...
  this.peptideDetails.sequence.id = 'spc_ele_sourceDialog_peptideDetails_sequence';
  this.peptideDetails.sequence.type = 'text';
  this.peptideDetails.sequence.classList.add('spc_cls_sourceDialog_sequence');
  this.peptideDetails.append(this.peptideDetails.sequence);

  this.peptideDetails.charge_label = document.createElement('label');
  this.peptideDetails.charge_label.for = 'spc_ele_sourceDialog_peptideDetails_charge';
  ...
  this.peptideDetails.charge.id = 'spc_ele_sourceDialog_peptideDetails_charge';
  ...
  [1,2,3,4,5,6].forEach(charge => { 
   ...
   option.setAttribute('value', charge);
  ...
  this.fixedModifications.classList.add('spc_cls_dialog_item');

  this.fixedModifications.label = document.createElement('label');
  this.fixedModifications.label.for = 'spc_ele_sourceDialog_fixedModifications_table';
  ...
  this.fixedModifications.table = new spc.UI.components.OptionTable(
   [],
   ['text','text'],
   ['Residue','Modification']
  );
  this.fixedModifications.table.node.id = 'spc_ele_sourceDialog_fixedModifications_table';
  ...
  this.crosslinkDetails.classList.add('spc_cls_dialog_item');

  this.crosslinkDetails.include = document.createElement('input');
  this.crosslinkDetails.include.id = 'spc_ele_sourceDialog_crosslinkDetails_include';
  ...
  this.crosslinkDetails.include_label.for = 'spc_ele_sourceDialog_crosslinkDetails_include';
  ...
  this.crosslinkDetails.sequence_label.for = 'spc_ele_sourceDialog_crosslinkDetails_sequence';
  ...
  this.crosslinkDetails.sequence.id = 'spc_ele_sourceDialog_crosslinkDetails_sequence';
  this.crosslinkDetails.sequence.type = 'text';
  this.crosslinkDetails.sequence.classList.add('spc_cls_sourceDialog_sequence');
  ...
  this.crosslinkDetails.linkType_label.for = 'spc_ele_sourceDialog_crosslinkDetails_linkType';
  ...
  this.crosslinkDetails.linkType.id = 'spc_ele_sourceDialog_crosslinkDetails_linkType';
  ...
  this.crosslinkDetails.positionA_label.for = 'spc_ele_sourceDialog_crosslinkDetails_positionA';
  ...
  this.crosslinkDetails.positionA.id = 'spc_ele_sourceDialog_crosslinkDetails_positionA';
  this.crosslinkDetails.positionA.type = 'number';
  this.crosslinkDetails.positionA.classList.add('spc_cls_sourceDialog_position');
  ...
  this.crosslinkDetails.positionB_label.for = 'spc_ele_sourceDialog_crosslinkDetails_positionB';
  ...
  this.crosslinkDetails.positionB.id = 'spc_ele_sourceDialog_crosslinkDetails_positionB';
  this.crosslinkDetails.positionB.type = 'number';
  this.crosslinkDetails.positionB.classList.add('spc_cls_sourceDialog_position');
  ...
  this.glycosylationDetails.classList.add('spc_cls_dialog_item');

  this.glycosylationDetails.include = document.createElement('input');
  this.glycosylationDetails.include.id = 'spc_ele_sourceDialog_glycosylationDetails_include';
  ...
  this.glycosylationDetails.include_label.for = 'spc_ele_sourceDialog_glycosylationDetails_include';
  ...
  this.glycosylationDetails.sequence_label.for = 'spc_ele_sourceDialog_glycosylationDetails_sequence';
  ...
  this.glycosylationDetails.sequence.id = 'spc_ele_sourceDialog_glycosylationDetails_sequence';
  this.glycosylationDetails.sequence.type = 'text';
  this.glycosylationDetails.sequence.classList.add('spc_cls_sourceDialog_sequence');
  ...
  this.glycosylationDetails.position_label.for = 'spc_ele_sourceDialog_glycosylationDetails_position';
  ...
  this.glycosylationDetails.position.id = 'spc_ele_sourceDialog_glycosylationDetails_position';
  this.glycosylationDetails.position.type = 'number';
  this.glycosylationDetails.position.classList.add('spc_cls_sourceDialog_position');
 ...
 let updateSourceSelect = function() {
  ...
  spc.UI.removeChildren(this.dataSource.chooser);
  let optGroup = document.createElement('optGroup');
  ...
  optionSelectNewFiles.setAttribute('value','__NEW__');
 ...
 let updateSourceDetails = function() {
  ...
  if ('sourceDetails_name' in this.ui.dialogSession.getCurrentCache()) {
   ...
   if (source.fileType == 'mzML' || source.fileType == 'mzXML') {
    ...
    spc.UI.show(this.mzFileDetails);
   }
 ...
 let updateFixedModifications = function() {
  this.fixedModifications.table.setData(this.fixedModifications.table.data,
   [Object.values(this.ui.app.definitions.aminoacids).map(v => v.token),
    Object.keys(this.ui.app.definitions.modifications)]
  );
 }

 let updateCrosslinkType = function() {
  let selectedClType = this.crosslinkDetails.linkType.value;
  spc.UI.removeChildren(this.crosslinkDetails.linkType);
  ...
  Object.keys(this.ui.app.definitions.crosslinkTypes).forEach(clType => { 
   let option = document.createElement('option');
   option.setAttribute('value', clType);
 ...
 _SourceDialog.prototype.accept = function() {
  ...
  if (this.dataSource.chooser.value.length) {
   ...
   aS.setAnnotation(new mslib.data.Peptide(peptideData));
  }
