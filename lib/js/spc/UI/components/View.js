export let View = function() {
 ...
 let topbar = function() {
  ...
  node.importButton.classList.add('spc_cls_topbarButton');
  ...
  node.annotateButton.classList.add('spc_cls_topbarButton','disable');
  middle.append(node.annotateButton);
  node.exportButton = document.createElement('div');
  node.exportButton.id = 'spc_ele_exportButton';
  node.exportButton.classList.add('spc_cls_topbarButton','disable');
